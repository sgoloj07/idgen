    ...
    <head>
		...
		$(document).ready(function() {
		  $('#btnSave1').on('click', function() {
			...
			// Temporarily set background image style
			var originalBackground = captureElem.style.backgroundImage;
			captureElem.style.backgroundImage = "url('./images/back2.png')";
				...
				<div id="collegeCard">
					...
					<div class="card-container" style="width: 432px; height:739.2px;" >
							...
							<span class=""></span>
								...
								<tr>
									<td>
										<div class="user-cards" style="width:400px;height:70px;margin-left: -90px;margin-top:0px;">
											<span>
									...
									<td>
										<div class="user-cards" style="width:195px;height:40px;margin-left: -100px;margin-top:0px;">
											<span>
