...
<html>
    <head>
		...
		$(document).ready(function() {
		  $('#btnSave2').on('click', function() {
			...
			captureElem.style.backgroundImage = "url('./images/FRONT EPER.png')";
		...
		$(document).ready(function() {
		  $('#btnSave1').on('click', function() {
			...
			// Temporarily set background image style
			var originalBackground = captureElem.style.backgroundImage;
			captureElem.style.backgroundImage = "url('./images/BACK EPER.png')";
    ...
    <body>		
        <header class="text-center">
                <h1>E-PER ID Card generator</h1>
				<input type="button" value="GVM ID" onclick="window.location.href='id.php'" class="button"><br>
            ...
            <div class="section-container">
				...
				<td>
					<div class="form-element">
                        ...
                        <input type="text" id="SSSnumber" oninput="generateCard()" />
                    </div>
					<div class="form-element">
                        <label class="form-label">
                            PHIC No.
                        </label>
                        <input type="text" id="PHICnumber" oninput="generateCard()" />
                    </div>
					<div class="form-element">
                        <label class="form-label">
                            Validity
				...
				<div id="collegeCard">
                    ...
                    <div class="card-containerses">
						...
						<div class="card-wrapper" style="width: 432px; height:739.2px;">
							<img src='./images/FRONT EPER.png' style='z-index:-1; position: absolute;'>   
					...
					<div class="card-container" style="width: 432px; height:739.2px;" >
							...
							<div class="card-wrapper" style="width: 432px; height:739.2px;">
							<img src='./images/BACK EPER.png' style='z-index:-1; position: absolute;'>   
